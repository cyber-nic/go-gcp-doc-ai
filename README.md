...
# Rate limiting
1. avg image sanitizing duration: 350ms
2. number of sanitized images per second, rounded down: 8
3. number of sanitized images per minute with 8 concurrent workers: 64
4. avg async ocr duration: 30 secs
5. Image Vision Text detection requests per minute: 1800